...
export class ImageAndTextComponent implements OnInit {
  ...
  @Input() src: string = '../../../assets/Images/Components/Large-usp/Digitalbyra som digitaliserer og utvikler nettsider.jpg';
  @Input() alt: string = '../../../assets/Images/Components/Large-usp/Digitalbyra som digitaliserer og utvikler nettsider.jpg';
