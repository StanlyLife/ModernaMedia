  ...
  UspCard = [
    {
      icon: '../../../assets/Images/Icons/rocket-9959.svg',
      imageSrc:
        '../../../assets/Images/Components/usp-image-cards/Farge kombinasjoner for design.webp',
      imageAlt: 'Alt tekst',
      content:
        'Alle våre nettsider bygges fra bunn, noe som vil si at vi kan lage ALT du vil ha innenfor teknologien og fysikkens lover',
      title: 'Raske Design for raske briller',
    },
    {
      icon: '../../../assets/Images/Icons/rocket-9959.svg',
      imageSrc:
        '../../../assets/Images/Components/usp-image-cards/Norsk design for bedrift.webp',
      imageAlt: 'Alt tekst',
      content:
        'Alle våre nettsider bygges fra bunn, noe som vil si at vi kan lage ALT du vil ha innenfor teknologien og fysikkens lover',
      title: 'Raske Design for raske briller',
    ...
    },
    {
      icon: '../../../assets/Images/Icons/rocket-9959.svg',
      imageSrc:
        '../../../assets/Images/Components/usp-image-cards/Samlet arbeid.webp',
      imageAlt: 'Alt tekst',
  ...
  Product = [
    {
      ...
      Content:
        'Vi utvikler nettsider og systemer for bedrifter av alle størrelser. En mindre bedrift har like stort behov for en nettside som en stor bedrift, men har ikke behov for en nettside av samme størrelse som en større bedrift',
      Icons: [
        {
    ...
    },
    {
      ...
      imageSrc:
        '../../../assets/Images/Components/Image-products-info/Barista.webp',
      imageAlt: 'Alt tekst',
      Subtitle: `Vi tar ikke betalt før produktet er ferdig, på denne måten er du helt <span class="${this.textColor}">fornøyd</span>, helt <span>risikofritt</span>`,
      Content:
